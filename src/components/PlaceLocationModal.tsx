  ...
  const initializeMap = () => {
    ...
    try {
      ...
      const infoWindow = new window.kakao.maps.InfoWindow({
        content: `
          <div style="padding: 12px 12px 16px 12px; min-width: 200px; max-width: 240px; font-family: 'Malgun Gothic', sans-serif; position: relative; word-wrap: break-word; overflow: hidden; box-sizing: border-box;">
